...
const SLIDES = [
  {
    ...
    tint: '#e7eefb',
    hue: '#3b6fd4',
    chip: { key: 'Documents', value: 'All 5 listed up front' },
    caption: 'Know every requirement before you start',
  },
  {
    id: 'agent',
    ...
    tint: '#e6f3ea',
    hue: '#2e9e5b',
    chip: { key: 'Your agent', value: 'Verified by an admin' },
    caption: 'A real, checked person handles your file',
  },
  {
    id: 'tracking',
    Art: TrackingArt,
    tint: '#fcf1dc',
    hue: '#eeae24',
    chip: { key: 'Status', value: 'Documents under review' },
    caption: 'Follow it all the way to the counter',
  },
];
